...
def normalize_text(text: str) -> str:
    """Chuẩn hóa text trước khi so sánh: Loại bỏ noise từ Markdown formatting và biểu mẫu."""
    if not text:
        return ""
        
    # 1. Bỏ qua toàn bộ dòng tiêu đề do VLM tự sinh ra (bắt đầu bằng #)
    ...
    # 2. Xóa các đường chấm chấm hoặc gạch dưới trong biểu mẫu (ví dụ: ..........., ________)
...
def main():
    ...
    with open(report, "w", encoding="utf-8") as f:
        f.write("BÁO CÁO ĐÁNH GIÁ ĐA CHIỀU — Doc Anchor AI OCR\n")
        f.write("=" * 110 + "\n\n")
